...
public class FlipHorizontal implements ImageCommands {
   ...
   */
  public FlipHorizontal(String fileName, String fileNew, ImageView view)
  ...
  public void runCommands(ImageGallery gallery) {
    ...
    SingleImage newImage = transform.flipHorizontal();
    gallery.put(this.fileNew, newImage);
    this.view.renderMessage("Successfully flipped " + this.fileName
            + " horizontally and saved as " + this.fileNew + System.lineSeparator());
  }
}
